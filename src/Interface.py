...
# Interface Chatinterface padrão do Gradio, clonada diretamente aqui ao invés de importada via gradio.Chatinterface para melhor customização da interface do chatbot.
